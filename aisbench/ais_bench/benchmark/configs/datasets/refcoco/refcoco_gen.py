...
from ais_bench.benchmark.datasets import RefCOCODataset, refcoco_bbox_postprocess
from ais_bench.benchmark.openicl.icl_evaluator import BBoxIoUEvaluator


refcoco_reader_cfg = dict(input_columns=["question", "image"], output_column="answer")
