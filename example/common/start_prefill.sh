...
echo "[start_prefill] dp_rank_start=${DP_RANK_START} dp_size=${P_DP_SIZE} local=${P_DP_SIZE_LOCAL} tp=${P_TP_SIZE}"
echo "[start_prefill] dp_address=${P_DP_ADDRESS} http=${HTTP_PORT} kv_base=${KV_PORT_BASE} visible=${VISIBLE_LIST:-auto}"
